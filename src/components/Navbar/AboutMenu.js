  ...
  return (
    <li tabIndex={0} className="hover:bg-[#c82848] rounded-xl">
      ...
      <ul className="p-2 bg-primary">
        ...
        <li className="hover:bg-[#c82848] rounded-xl">
          <NavLink to="/voiceOfChairman">Voice Of Chairman</NavLink>
        </li>
        <li className="hover:bg-[#c82848] rounded-xl">
          <NavLink to="/voiceOfPrincipal">Voice Of Principal</NavLink>
        </li>
        <li className="hover:bg-[#c82848] rounded-xl">
          <NavLink to="/mission&vision">Mission And Vision</NavLink>
        </li>
        <li className="hover:bg-[#c82848] rounded-xl">
          <NavLink to="/gov_body">Governing Body</NavLink>
        </li>
      </ul>
    </li>
  );
