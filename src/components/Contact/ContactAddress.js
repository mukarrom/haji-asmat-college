...
const ContactAddress = () => {
  return (
    <div class="lg:w-1/2 lg:mx-6 flex flex-col items-center justify-center">
      ...
      <div class="mt-6 space-y-12 md:mt-8 grid grid-cols-1">
        {/* Location */}
        <p class="flex flex-col items-center justify-start">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="w-16 mx-2 text-blue-500 dark:text-blue-400"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            stroke-width="2"
        ...
        <div className="flex justify-evenly space-x-12">
          ...
          <p class="flex flex-col items-center justify-start">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="w-16 text-blue-500 dark:text-blue-400"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              stroke-width="2"
