...
function UpdateChairman() {
	...
	const { id } = useParams();
	const [isLoading, error, data] = useGetData('chairman', id);
		...
		if (form) {
			...
			fetch(`https://mmh.cyclic.app/api/v1/dynamic/${data?._id}`, {
				...
				.then((chairmanData) => {
					...
					if (chairmanData?.modifiedCount) {
						// if (data?.modifiedCount) {
						toast.success('The chairman updated in database successfully');
						// }
						// if (data?.result?.modifiedCount) {
						//     toast.success('The chairman post  updated in database successfully');
						// }
					} else {
				...
				<form onSubmit={handleFormSubmit} className="">
					<div className="form-control w-full ">
						...
						<label className="label">
							<span className="label-text">Write voice of chairman title</span>
						</label>
						<input
							name="title"
							type="text"
					...
					{/* <div className="form-control w-full"> */}
					{/*    <label className="label"> */}
					{/*        <span className="label-text">Write chairman short description</span> */}
					{/*    </label> */}
					{/*    <textarea */}
					{/*        name="category" */}
					{/*        type="text" */}
					...
					{/* </div> */}
					{/* /!* >-------------->3. Date input end <--------------< *!/ */}
					{/* >-------------->5. chairman Text Editor <--------------< */}
					<div className="form-control lg:col-span-2">
						<label className="label">
							<span className="label-text">Your chairman detail</span>
						</label>
						<JoditEditor
							required
							// ref={editor}
