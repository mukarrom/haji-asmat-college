...
function UpdateMission() {
	...
	const { id } = useParams();
	const [isLoading, error, data] = useGetData('mission', id);
		...
		if (form) {
			...
			fetch(`https://mmh.cyclic.app/api/v1/dynamic/${data?._id}`, {
				...
				.then((missionData) => {
					...
					if (missionData?.modifiedCount) {
						// if (data?.modifiedCount) {
						toast.success('The mission updated in database successfully');
						// }
						// if (data?.result?.modifiedCount) {
						//     toast.success('The mission post  updated in database successfully');
						// }
					} else {
				...
				<form onSubmit={handleFormSubmit} className="">
					<div className="form-control w-full ">
						...
						<label className="label">
							<span className="label-text">Write mission and vision title</span>
						</label>
						<input
							name="title"
							type="text"
					...
					{/* <div className="form-control w-full"> */}
					{/*    <label className="label"> */}
					{/*        <span className="label-text">Write mission short description</span> */}
					{/*    </label> */}
					{/*    <textarea */}
					{/*        name="category" */}
					{/*        type="text" */}
					...
					{/* </div> */}
					{/* /!* >-------------->3. Date input end <--------------< *!/ */}
					{/* >-------------->5. mission Text Editor <--------------< */}
					<div className="form-control lg:col-span-2">
						<label className="label">
							<span className="label-text">mission and vision detail</span>
						</label>
						<JoditEditor
							required
							// ref={editor}
