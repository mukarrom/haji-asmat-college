...
function Home() {
	return (
		<div className="bg-base-100">
			...
			{/*<Facility />*/}
			<div className="bg-light-red w-full py-2 font-bold text-white text-4xl font-bn-hand flex justify-center items-center">
				<span>এক নজরে</span>
			</div>
			<AboutCollege />
			{/*--------------------- government body --------------------*/}
			<section>
				...
				<div className="flex justify-center">
					<Link to="/gov_body" className="btn btn-outline btn-primary">
						আরও...
					</Link>
				</div>
			</section>
